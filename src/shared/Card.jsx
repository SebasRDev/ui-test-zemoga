...
export const Card = ({celebrity}) => {
  const {name, description, category, picture, lastUpdated} = celebrity;
  ...
  return (
    <div className="voting-card">
      <img className="voting-card__portrait" src={`./assets/img/${picture}`} alt="Kanye West" />
      <div className='voting-card__content'>
        ...
        <div className='votin-card__votes'>
          <p>{calculateDiferenceDates(lastUpdated)} in <span>{category}</span></p>
          <Thumb type="up" />
          <Thumb type="down" />
